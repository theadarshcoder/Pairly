...
export default function AuthPage() {
  ...
  return (
    <div className="auth-fixed-viewport">
      ...
      {/* Main Centered Content (Zero document scroll) */}
      ...
      <style>{`
        ...
        .auth-bg-radial {
          ...
          width: 720px;
          height: 480px;
          background: radial-gradient(50% 50% at 50% 50%, rgba(158, 212, 239, 0.22) 0%, rgba(250, 247, 242, 0) 100%);
        }
        ...
        .auth-stationery-card {
          ...
          box-shadow: 0 16px 40px -10px rgba(0, 0, 0, 0.07), 0 2px 6px rgba(0, 0, 0, 0.02);
          padding: 24px 28px;
          overflow: hidden;
        }
        ...
        [data-theme="dark"] .auth-portal-badge {
